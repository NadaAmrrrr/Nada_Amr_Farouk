...
//import 'package:task2/task3.dart';
//import 'package:task2/task4.dart';
//import 'package:task2/task5.dart';


void main() {
 //task1
 var book = Book('flutter ', 'Nada', 200);
book.displayInfo();

 //task2
 //var novel = Novel('flutter', 'nada', 200, 'programming');
  //novel.displayInfo();
/* 
//task3
var circle = Circle(5);
